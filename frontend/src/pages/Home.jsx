        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div className="">
              ...
              md:text-[60px] md:leading-[70px]"
                ...
                <p className="text_para">
                  ...
                  Enim, eveniet! Voluptatum dolorum veniam nostrum quod saepe
                  expedita soluta unde enim, cupiditate sit, quidem eligendi
                  praesentium rem natus dolores earum beatae.
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              <div className="">
                <img className="w-full" src={heroImg1} alt="hero-image-1" />
              </div>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  ...
                  autem ut deleniti voluptas quia veritatis, est.
                </p>
                <Link
                  to="/doctors"
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get Online Treatment <br /> Anytime you want
              </h2>
              <ul className="pl-4">
                ...
                <li className="text_para">
                  2. Find a doctor here and contact their office directly.
                </li>
                <li className="text_para">
                  3. Use our online booking tool to find out which clinics are
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              >
                ...
                <div
                  className="w-[92px] lg:w-[133px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] 
